...
```json
{
  ...
  "problem_contract": {
    ...
    "definitions": [
      {
        "definition": "A vertex set D such that every vertex outside D has a neighbor in D.",
        "term": "dominating set"
      },
      {
        "definition": "The minimum cardinality of a dominating set of G.",
        "term": "domination number γ(G)"
      },
      {
        "definition": "A graph in which every vertex has degree 3.",
        "term": "cubic graph"
      }
    ],
    "domain": {
      "description": "Finite simple 3-connected 3-regular graphs.",
      "objects": [
        "cubic graph",
        "3-connected graph",
        "dominating set",
    ...
    "problem_id": "problem:opg-37038-cubic-domination",
    "quantifiers": [
      {
        "domain": "finite simple 3-connected cubic graphs",
        "kind": "forall",
        "variables": [
          "G"
        ]
      ...
      {
        "domain": "dominating sets D⊆V(G) with |D|≤⌈|V(G)|/3⌉",
        "kind": "exists",
        "variables": [
          "D"
        ]
    ...
    "sources": [
      {
        ...
        "source": "UnsolvedMath",
        "source_record_id": "unsolvedmath-opg-37038-065d74afe0b0",
        "url": "https://www.unsolvedmath.com/problems/OPG-37038"
      },
      {
    ...
    "statement": {
      "language": "en",
      "text": "Does every finite simple 3-connected cubic graph G have domination number γ(G) at most ⌈|V(G)|/3⌉?",
      "version": 1
    },
    "title": "Domination in 3-connected cubic graphs",
    "updated_at": "2026-09-06T04:47:54Z"
  },
  "problem_contract_sha256": "4a423538b21acac64c6319fcd5424c4ca603691bd6da04b015fe49c0fb868c01"
}
```
